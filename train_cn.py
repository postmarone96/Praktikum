...
train_loader = DataLoader(train_dataset, batch_size=14, shuffle=True, num_workers=16, persistent_workers=True)
val_loader = DataLoader(validation_dataset, batch_size=14, shuffle=False, num_workers=16, persistent_workers=True)
