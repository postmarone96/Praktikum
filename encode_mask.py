...
for epoch in range(start_epoch, n_epochs):
    ...
    if epoch % 5 == 0 and epoch > 0:
        save_checkpoint_vae(epoch, autoencoderkl, discriminator, optimizer_g, optimizer_d, scheduler_d, 
                            ...
                            intermediary_images, lr_rates_g, lr_rates_d, val_epochs, f'mask_checkpoint_epoch_{epoch}.pth')
        if val_loss < vae_best_val_loss:
            ...
            save_checkpoint_vae(epoch, autoencoderkl, discriminator, optimizer_g, optimizer_d, 
                                ...
                                epoch_gen_losses, epoch_disc_losses, intermediary_images, lr_rates_g, lr_rates_d, val_epochs, 'mask_best_checkpoint.pth')
    ...
    if epoch > val_interval:
        ...
        plt.savefig('Mask_Enc_learning_curves.png')
        plt.close()
...
save_checkpoint_vae(epoch, autoencoderkl, discriminator, optimizer_g, optimizer_d, scheduler_d, 
                            scheduler_g, val_recon_losses, epoch_recon_losses, epoch_gen_losses, epoch_disc_losses, 
                            intermediary_images, lr_rates_g, lr_rates_d, val_epochs, f'mask_model_{date_time}.pth')
del discriminator
del perceptual_loss
torch.cuda.empty_cache()