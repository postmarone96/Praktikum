...
scheduler_g = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer_g, 'min', factor=0.5)
scheduler_d = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer_d, 'min', factor=0.5)
